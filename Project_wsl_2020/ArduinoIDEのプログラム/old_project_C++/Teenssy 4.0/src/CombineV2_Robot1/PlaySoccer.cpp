    ...
    while (!ControlSW_left && !ControlSW_front)
    {
        ...
        */
        ...
        if (ControlLevel == 1)
        {
            ...
            {
                ControlmotorPower[0] = -sin(radians(0 - 60)) * 0.88; // アナログステックのXY成分
            ...
            {
                ControlmotorPower[0] = -sin(radians(180 - 60)) * 0.88; // アナログステックのXY成分
        ...
        else
        {
            if (LStick_Angle_Radjust == 0)
            {
                ControlmotorPower[0] = -sin(radians(0 - 60)) * 0.7;  // アナログステックのXY成分
                ControlmotorPower[1] = sin(radians(0 - 300));        // アナログステックのXY成分
                ControlmotorPower[2] = -sin(radians(0 - 135));       // アナログステックのXY成分
                ControlmotorPower[3] = sin(radians(0 - 225)) * 0.88; // アナログステックのXY成分
            }
            if (LStick_Angle_Radjust == 180)
            {
                ControlmotorPower[0] = -sin(radians(180 - 60)) * 0.7;  // アナログステックのXY成分
                ControlmotorPower[1] = sin(radians(180 - 300));        // アナログステックのXY成分
                ControlmotorPower[2] = -sin(radians(180 - 135));       // アナログステックのXY成分
                ControlmotorPower[3] = sin(radians(180 - 225)) * 0.88; // アナログステックのXY成分
            }
        }
        // 右と左の調整
