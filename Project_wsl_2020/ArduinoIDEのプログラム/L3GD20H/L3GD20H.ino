...
void Output_DegData() {
  ...
  long outputdata = (degdata / 480.0 / 100.0) * 2;
  /*if (outputdata > 1023) {
    outputdata = 1023;
  ...
  if (outputdata > 0) {
    outputdata = (outputdata + 1023) % 1023;
  } else {
    outputdata = 1023 - (abs(outputdata)) % 1023;
  }
  /*
  outputdata = map(outputdata,0,1023,0,359);
  if (outputdata > 512) {
    outputdata = map(outputdata,512,1023,0,360);
  } else {
    outputdata = map(outputdata,512,0,360,0);
  }
