...
void user_main(void)
{
  ...
  while (TRUE) {
    ...
    } else if (sub_io_get_sensor(1, CN2) < 204) {
      set_Led(0, LED_ON);
      clr_timer(0);
    ...
    } else if (sub_io_get_sensor(1, CN6) < 204) {
      set_Led(0, LED_ON);
      clr_timer(0);
      RfLb_X = MoterSpeed;  	// 前に行く
      LfRb_Y = MoterSpeed;  	// 前に行く
    } else if (sub_io_get_sensor(1, CN8) < 204) {
      set_Led(0, LED_ON);
      clr_timer(0);
      RfLb_X = MoterSpeed;  	// 前に行く
      LfRb_Y = MoterSpeed;  	// 前に行く
    } else if (gAD[CN10] < 102) {
      set_Led(0, LED_ON);
      clr_timer(0);
      RfLb_X = MoterSpeed;  	// 右に行く
      LfRb_Y = -MoterSpeed;  	// 右に行く
    } else if (sub_io_get_sensor(1, CN4) < 204) {
      set_Led(0, LED_ON);
      clr_timer(0);
      RfLb_X = MoterSpeed;  	// 右に行く
      LfRb_Y = -MoterSpeed;  	// 右に行く
    } else if (sub_io_get_sensor(1, CN3) < 204) {
      set_Led(0, LED_ON);
      clr_timer(0);
      RfLb_X = MoterSpeed;  	// 右に行く
      LfRb_Y = -MoterSpeed;  	// 右に行く
    ...
    } else if (sub_io_get_sensor(1, CN1) < 204) {
      set_Led(0, LED_ON);
      clr_timer(0);
      RfLb_X = -MoterSpeed;  	// 左に行く
      LfRb_Y = MoterSpeed;  	// 左に行く
