...
#include "D_EIO.h"
//--------------------------------------------------------------------------------
// Program Name : NewFile-05.C
//--------------------------------------------------------------------------------
void user_main(void)
{
  double IR_motermax = 100;  	// 回り込む際のモータの最大出力
  double IR_motermin = 50;  	// 回り込む際のモータの最低出力
  double IR_moterValue = 100;  	// 回り込む際のモーター出力結果
  double IR_frontValue = 6;  	// 前とみなす、角度の範囲
