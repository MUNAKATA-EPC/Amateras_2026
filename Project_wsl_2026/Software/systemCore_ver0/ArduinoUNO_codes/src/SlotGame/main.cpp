...
// ブザーの設定
Tone tone1;
const char *SWPushSounds = "M1:d=4,o=5,b=120:16g,16c6";          // スイッチ効果音
const char *SWStopSounds = "M1:d=4,o=5,b=120:16g";               // スイッチ効果音
const char *SuccessSounds = "M4:d=4,o=5,b=120:8c,8g,8c6,8g,8c6"; // 成功の効果音
const char *Failure1Sounds = "M6:d=4,o=5,b=100:g3,g3";           // 失敗の効果音
const char *Failure2Sounds = "M7:d=8,o=4,b=140:c,c#,d,d#,e";     // 失敗の効果音
const char *Failure3Sounds = "M8:d=4,o=6,b=120:c6,b,a,g";        // 失敗の効果音
const char *Failure4Sounds = "M9:d=8,o=5,b=100:c6,8p,a,8p,f";    // 失敗の効果音
const char *Failure5Sounds = "M10:d=16,o=5,b=90:e,d#,d,c#,c";    // 失敗の効果音
