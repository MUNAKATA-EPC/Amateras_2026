...
#define DEFENCE_YELLOW_GOAL_NORMAL_DEG 165 // 普通に守備をする角度(これを超えると対角線で守る)
#define DEFENCE_BLUE_GOAL_NORMAL_DEG 165

// DEFENCE認識条件-------------------------------------------------------------------
// USS
#define DEFENCE_USS_DIS_MIN 35 // ディフェンスの処理に移る最低の距離
// 1段階目
...
//// MODORU処理 ////
#define MODORU_YELLOW_GOAL_DIS 60.0f // ゴール近距離を判断する距離とその時の力 (ゴールから逃げる・近寄る)
