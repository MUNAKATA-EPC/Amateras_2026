...
//// DEFENCE処理 ////
#define DEFENCE_IR_FRONT_Y_MAX 100.0f  // ボールのy座標がこの値から
#define DEFENCE_IR_FRONT_Y_MIN -100.0f // この値までであったら停止する

#define DEFENCE_YELLOW_GOAL_NORMAL_DEG 155 // 普通に守備をする角度(これを超えると対角線で守る)
#define DEFENCE_BLUE_GOAL_NORMAL_DEG 155

// DEFENCE認識条件-------------------------------------------------------------------
// USS
#define DEFENCE_USS_DIS_MIN 30 // ディフェンスの処理に移る最低の距離
// 1段階目
#define DEFENCE_YELLOW_GOAL_DIS1 85.0f // ディフェンスの処理に移る距離
#define DEFENCE_BLUE_GOAL_DIS1 85.0f

#define DEFENCE_YELLOW_GOAL_DEG1 120 // ディフェンスの処理に移る角度
#define DEFENCE_BLUE_GOAL_DEG1 120
// 2段階目(端に近いときは厳しい条件)
#define DEFENCE_YELLOW_GOAL_DIS2 85.0f // ディフェンスの処理に移る距離
#define DEFENCE_BLUE_GOAL_DIS2 85.0f

#define DEFENCE_YELLOW_GOAL_DEG2 90 // ディフェンスの処理に移る角度
#define DEFENCE_BLUE_GOAL_DEG2 90
// ---------------------------------------------------------------------------------

#define DEFENCE_LINE_TRACE_POWER_MAX 10.0f // ライントレースに使う力の上限
...
//// MODORU処理 ////
#define MODORU_YELLOW_GOAL_DIS 62.0f // ゴール近距離を判断する距離とその時の力 (ゴールから逃げる・近寄る)
#define MODORU_BLUE_GOAL_DIS 65.0f

#define MODORU_POWER 60.0f           // この力で戻りながら
#define MODORU_IR_FOLLOW_POWER 15.0f // この力でボールを追う
