...
void Ps3_compute_update()
{
    if (is_Ps3_stick_left_move())
    {
        ...
        ps3_stick_left_distance = (int)sqrt(get_Ps3_stick_lx() * get_Ps3_stick_lx() + get_Ps3_stick_ly() * get_Ps3_stick_ly()); // 左スティックの距離を求める
    ...
    if (is_Ps3_stick_right_move())
    {
        ...
        ps3_stick_right_distance = (int)sqrt(get_Ps3_stick_rx() * get_Ps3_stick_rx() + get_Ps3_stick_ry() * get_Ps3_stick_ry()); // 右スティックの距離を求める
